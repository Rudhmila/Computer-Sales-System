...
--
-- Host: localhost    Database: computer_sales_system
-- ------------------------------------------------------
...
CREATE TABLE `company_info` (
  ...
  `Stock_Location` varchar(50) DEFAULT NULL,
...
CREATE TABLE `items` (
  ...
  `Warranty_Details` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `items_details` (
  ...
  `Gift_Voucher` varchar(50) DEFAULT NULL,
...
-- Dump completed on 2024-10-30 11:17:31
